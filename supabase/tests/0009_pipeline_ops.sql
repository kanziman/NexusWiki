...
values
  ('20000000-0000-0000-0000-000000000021', '큐·취소 계약',   'pipeline-dead',      '10000000-0000-0000-0000-000000000021'),
  ('20000000-0000-0000-0000-000000000022', '인큐 멱등성',     'pipeline-idempotent', '10000000-0000-0000-0000-000000000021'),
  ('20000000-0000-0000-0000-000000000023', '상한 경계',       'pipeline-limit',     '10000000-0000-0000-0000-000000000021'),
  ('20000000-0000-0000-0000-000000000024', '빈 워크스페이스', 'pipeline-empty',     '10000000-0000-0000-0000-000000000021'),
  ('20000000-0000-0000-0000-000000000025', '남의 워크스페이스', 'pipeline-outsider',  '10000000-0000-0000-0000-000000000021'),
  ('20000000-0000-0000-0000-000000000026', '월 경계',         'pipeline-month',     '10000000-0000-0000-0000-000000000021');
...
--
-- 상한 1000 micros. 999에서는 통과하고, 1 micro를 더해 정확히 1000이 되면 NW402.
...
begin
  begin
    ...
    v_state := 'ok';
  exception when sqlstate 'NW402' then
    v_state := 'capped';
  end;
