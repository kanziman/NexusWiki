...
- [ ] **BOOT-10**: 프로덕션 인증 설정이 하드닝된다 (비밀번호 길이, 이메일 확인 — 팀 제품에 CLI 기본값 사용 금지)
...
|-------------|-------|--------|
| BOOT-01 | Phase 1 | Gaps Found |
| BOOT-02 | Phase 1 | Gaps Found |
| BOOT-03 | Phase 1 | Gaps Found |
| BOOT-04 | Phase 1 | Gaps Found |
| BOOT-05 | Phase 1 | Gaps Found |
| BOOT-06 | Phase 1 | Gaps Found |
| BOOT-07 | Phase 1 | Gaps Found |
| BOOT-08 | Phase 1 | Gaps Found |
| BOOT-09 | Phase 1 | Gaps Found |
| BOOT-10 | Phase 1 | Gaps Found |
